...
public class SendMessage {
    ...
    //this method sends message to the receiver
    public void sendMessage(String uid, String rid, String message) {
        //setting server url
        final String SERVER_URL = ServerURL.serverURL + "SendMessage.jsp";
        ...
        try
        {
            ...
            String data = URLEncoder.encode("sid", CHAR_SET) + "=" + URLEncoder.encode(uid, CHAR_SET);
            data += "&" + URLEncoder.encode("rid", CHAR_SET) + "=" + URLEncoder.encode(rid, CHAR_SET);
            data += "&" + URLEncoder.encode("message", CHAR_SET) + "=" + URLEncoder.encode(message, CHAR_SET);
