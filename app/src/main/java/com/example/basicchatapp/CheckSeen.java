...
public class CheckSeen {
    ...
    //this method checks if the receiver has seen the message or not
    public String checkSeen(String uid, String rid) {
        //setting server url
        final String SERVER_URL = ServerURL.serverURL + "CheckSeen.jsp";
