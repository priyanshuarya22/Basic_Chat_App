...
public class UserStatus {
    ...
    //this method sets the user status on the server
    public void SetStatus(String uid, String status) {
        //setting server url
        final String SERVER_URL = ServerURL.serverURL + "SetStatus.jsp";
        ...
        try
        {
            ...
            data += "&" + URLEncoder.encode("status", CHAR_SET) + "=" + URLEncoder.encode(status, CHAR_SET);
    ...
    //this method gets the info of active users from the server
    public String getActiveUsers() {
        //setting server url
        final String SERVER_URL = ServerURL.serverURL + "GetActiveUsers.jsp";
        //setting character set to english
        final String CHAR_SET = "UTF-8"; // Encoding used for the parameters
        //setting output to null
        OutputStream output = null;
    ...
    //this method gets the info of offline users from the server
    public String getOfflineUsers() {
        //setting server url
        final String SERVER_URL = ServerURL.serverURL + "GetOfflineUsers.jsp";
        //setting character set to english
        final String CHAR_SET = "UTF-8"; // Encoding used for the parameters
        //setting output to null
        OutputStream output = null;
